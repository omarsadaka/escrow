...
const SideMenu = ({ navigation }) => {
    ...
    return (
        <ScrollView>
          ...
          <View style={{paddingHorizontal: wp(2),paddingBottom:hp(7)}}>
            <TouchableOpacity
                      ...
                      el.name == "inviteFriends"
                        ...
                        ? () =>
                            stackValue
                              ...
                              : navigation.navigate(el.link) //navigation.navigate(el.stack, { screen: el.link }) navigation.navigate(el.link)
                        : () => {}
                    }
                    style={styles.accountSettingsSideMenueDatacont}
                  >
